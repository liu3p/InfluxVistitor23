...
import gui.components.actions.CreateDataBaseAction;
import gui.components.actions.DisconnectAction;
import gui.components.actions.DropDatabaseAction;
import gui.components.actions.DropMeasuramentAction;
import gui.components.actions.DropSeriesAction;
import gui.components.actions.ManageAction;
import gui.components.actions.NewQueryAction;
import gui.components.actions.RefreshAction;
import gui.components.actions.RunBackFillAction;
import gui.components.actions.RunQueryAction;
import gui.components.actions.ShowContinuousQueriesAction;
import gui.components.actions.ShowDiagnosticsAction;
import gui.components.actions.ShowFieldKeysAction;
import gui.components.actions.ShowQueriesAction;
import gui.components.actions.ShowRetentionPoliciesAction;
import gui.components.actions.ShowSeriesAction;
import gui.components.actions.ShowStaticsAction;
import gui.components.actions.ShowTagKeysAction;
import gui.components.actions.ShowTagValuesAction;
import gui.components.actions.ShowUsersAction;
